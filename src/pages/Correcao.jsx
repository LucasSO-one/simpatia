...
e coloque referências bibliográficas.
  ...
  async function handleQuestionSubmit() {
    ...
    if (!pergunta.trim() || !respostaAluno.trim()) {
      ...
      mostrarNotificacao(
        "Preencha a pergunta e a resposta do aluno."
      );
        ...
        <section className="container-card">
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              value={respostaAluno}
              onChange={(e) =>
                setRespostaAluno(e.target.value)
              }
            />
          ...
          <div className="form-group">
            ...
            <label>
              Gabarito / Palavras-chave esperadas
            </label>
        ...
        <section className="container-card">
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              value={promptGerado}
              onChange={(e) =>
                setPromptGerado(e.target.value)
              }
            />
